type ArrowEnterProps = React.SVGAttributes<SVGSVGElement>;
  ...
  return (
    <svg width="11" height="12" viewBox="0 0 11 12" fill="none" {...props}>
      ...
      <path
        ...
        fill="currentColor"
      ></path>
      <rect x="2" y="10.4" width="2" height="4" rx="1" transform="rotate(-135 2 10.4)" fill="currentColor"></rect>
      <rect x="0.600006" y="9" width="2" height="4" rx="1" transform="rotate(-45 0.600006 9)" fill="currentColor"></rect>
    </svg>
  );
}
